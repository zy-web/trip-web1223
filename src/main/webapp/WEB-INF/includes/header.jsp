...
<link href="${path}/static/css/bootstrap.min.css" rel="stylesheet">
    <!-- Fontawesome -->
    <link href="${path}/static/asset/css/font-awesome.css" rel="stylesheet">
    <!-- Flaticons -->
    <link href="${path}/static/asset/css/font/flaticon.css" rel="stylesheet">
    <!-- Slick Slider -->
    <link href="${path}/static/asset/css/slick.css" rel="stylesheet">
    <!-- Range Slider -->
    <link href="${path}/static/asset/ion.rangeSlider.min.css" rel="stylesheet">
    <!-- Datepicker -->
    <link href="${path}/static/asset/css/datepicker.css" rel="stylesheet">
    <!-- magnific popup -->
    <link href="${path}/static/asset/css/magnific-popup.css" rel="stylesheet">
    <!-- Nice Select -->
    <link href="${path}/static/asset/css/nice-select.css" rel="stylesheet">
    <!-- Custom Stylesheet -->
    <link href="${path}/static/asset/css/style.css" rel="stylesheet">
    <!-- Custom Responsive -->
    <link href="${path}/static/asset/css/responsive.css" rel="stylesheet">
    <!-- Google Fonts -->
