						...
						<form class="form-horizontal" action="/admin/trafficEditHandle" method="post">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="currentTime" value="${traffic.tpCurrentTime}" class="form-control" id="currentTime"
										       placeholder="${traffic.tpCurrentTime}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="arriveTime" value="${traffic.tpArriveTime}" class="form-control" id="arriveTime"
										       placeholder="${traffic.tpArriveTime}">
									</div>
								</div>
