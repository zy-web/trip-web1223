...
<script>
 ...
 <script src="${path}/static/asset/js/jquery.min.js"></script>
    <!-- Popper -->
    <script src="${path}/static/asset/js/popper.min.js"></script>
    <!-- Bootstrap -->
    <script src="${path}/static/asset/js/bootstrap.min.js"></script>
    <!-- Range Slider -->
    <script src="${path}/static/asset/js/ion.rangeSlider.min.js"></script>
    <!-- Slick Slider -->
    <script src="${path}/static/asset/js/slick.min.js"></script>
    <!-- Datepicker -->
    <script src="${path}/static/asset/js/datepicker.js"></script>
    <script src="${path}/static/asset/js/datepicker.en.js"></script>
    <!-- Isotope Gallery -->
    <script src="${path}/static/asset/js/isotope.pkgd.min.js"></script>
    <!-- Nice Select -->
    <script src="${path}/static/asset/js/jquery.nice-select.js"></script>
    <!-- magnific popup -->
    <script src="${path}/static/asset/js/jquery.magnific-popup.min.js"></script>
    <!-- Maps -->
    <script src="https://ditu.google.cn/maps/api/js?key=AIzaSyDnd9JwZvXty-1gHZihMoFhJtCXmHfeRQg"></script>
    <!-- Custom Js -->
    <script src="${path}/static/asset/js/custom.js"></script>